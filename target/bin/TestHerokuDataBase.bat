...
%JAVACMD% %JAVA_OPTS% %EXTRA_JVM_ARGUMENTS% -classpath %CLASSPATH_PREFIX%;%CLASSPATH% -Dapp.name="TestHerokuDataBase" -Dapp.repo="%REPO%" -Dbasedir="%BASEDIR%" org.example.Main %CMD_LINE_ARGS%
